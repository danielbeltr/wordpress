...
if( function_exists('acf_add_options_page') ) {
	...
	acf_add_options_sub_page(array(
		...
		'menu_title'	=> 'Opciones de cabecera',
		'parent_slug'	=> 'theme-general-settings',
	));
	
	acf_add_options_sub_page(array(
		'page_title' 	=> 'Opciones de pie',
		'menu_title'	=> 'Opciones de pie',
		'parent_slug'	=> 'theme-general-settings',
	));
...
function my_acf_init() {
	...
	acf_update_setting('google_api_key', 'AIzaSyD4siw_Y_hgB51Zya0ib27OklSEXn6XTPM');
}
...
function custom_post_type() {
	...
	$labels = array(
		...
		'add_new'               => __( 'Agregar sucursal', 'text_domain' ),
